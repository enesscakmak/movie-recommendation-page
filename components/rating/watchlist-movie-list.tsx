...
export function WatchlistMovieList({ movies, onRate, onRemove }: WatchlistMovieListProps) {
  ...
  if (movies.length === 0) {
    return (
      <div className="rounded-md border p-8 text-center">
        <p className="text-muted-foreground">Your watchlist is empty - bookmark a film to save it here.</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium">Watchlist ({movies.length})</h3>
